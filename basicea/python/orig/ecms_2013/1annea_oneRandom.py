# Runs one EA, run these scripts in parallel to obtain averaged data
# generated data are stored into folder data/ with (probably) unique name
# by Jaroslav Vitku

# run: 
"""
/home/j/workspace/hanns/network/nengoros/simulator-ui/nengo-cl /home/j/workspace/hanns/network/nengoros/simulator-ui/experiments/1annea_oneRandom.py
"""
import nef
import random
...
elif (config ==4 ): # 4x4 fully connected ANN, increase pMut slightly (and generations)
    useRecurrent =True
    pMut = 0.15
    pCross = 0.9;
    popsize = 30;
